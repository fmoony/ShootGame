...
- [Rifle 左手 IK 与瞄准同步提速实施计划](Docs/执行计划/Rifle左手IK与瞄准同步提速实施计划.md)：阶段性完成；Rifle 左手握持已验收，未执行的同步调参由新的表现收尾计划接管。
- [武器贴墙稳定与瞄准表现收尾实施计划](Docs/执行计划/武器贴墙稳定与瞄准表现收尾实施计划.md)：当前执行计划；承接已验收的 Rifle 左手握持，依次处理第一人称贴墙抖动、快速瞄准同步和双臂姿势收尾。
